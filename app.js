    ...
    return `
        <div class="week-row">
            <div class="week-cell">
                ...
                <div class="week-emp-meta">
                    <span class="week-emp-position ${positionCssClass(employee.position)}">${positionDisplay}</span>
                    <span class="week-emp-hours"><i class="fas fa-clock"></i>${weeklyHours}h</span>
                </div>
            </div>
            ${days.map(day => {
